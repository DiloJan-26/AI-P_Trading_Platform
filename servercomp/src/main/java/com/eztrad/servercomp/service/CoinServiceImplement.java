...
import com.eztrad.servercomp.repository.CoinRepository;
...
//Step 59 - coin service implementation
// go to step 60 - CoinRepository and come back
@Service
public class CoinServiceImplement implements CoinService {
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/"+coinId+"markets?vs_currency=usd&per_page=10&days="+days ;
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            Coin coin = new Coin();
            coin.setId(jsonNode.get("id").asText());  // modification needed from that .asText is older version
            coin.setName(jsonNode.get("name").asText());
            coin.setSymbol(jsonNode.get("symbol").asText());
            coin.setImage(jsonNode.get("image").get("large").asText());

            JsonNode marketData = jsonNode.get("market_data");
            // @4:19:20 - go and see the data here https://api.coingecko.com/api/v3/coins/bitcoin (no need to run just see the data)
    ...
    // exactly same as get_market_chart override and just url only change
    @Override
    ...
    // here also exactly same as get_market_chart override and just url only change
    @Override
    ...
    public String getTradingCoins() throws Exception {
        ...
        // next go and create the controller for this - CoinController
    }
}
