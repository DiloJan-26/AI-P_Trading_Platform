...
public class CoinController {
    ...
    ResponseEntity<List<Coin>> getCoinList(
            @RequestParam( // edited while testing step 118
                    required = false,
                    name = "page"
    ...
    // So now the coin api is ready
    // so it's time to create the wallet api and order api
    // lets go first for wallet api
