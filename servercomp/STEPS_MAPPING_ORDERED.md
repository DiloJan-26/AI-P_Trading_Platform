...
| **114.1** | `application.properties.example`                | Line     | This is a copy of application.properties for the purpose of abstracting sensitive information like database credentials and Payment Gateway API keys.                                                                            |
| **114.2** | `.gitignore`                                    | Line     | Sensitive Configuration Files that Contains API keys and secrets - DO NOT COMMIT >> src/main/resources/application.properties, application-dev.properties, application-prod.properties and target/classes/application.properties |
| **114.3** | `application.properties`                        | Line     | Delever the actual Stripe Secret Key to the application. and git ignored                                                                                                                                                         |
...
| **116**   | `repository/WalletTransactionRepository.java`   | N/A      | Repository for Wallet to wallet Transaction to manage transaction history                                                                                                                                                        |
| **116.1** | `service/TransactionService.java`               | N/A      | Service for managing wallet transactions and transaction history                                                                                                                                                                 |
| **116.2** | `service/TransactionServiceImplement.java`      | N/A      | Implementation of TransactionService for wallet transaction management                                                                                                                                                           |
| **116.3** | `service/WalletServiceImplement.java`           | N/A      | Implement wallet-to-wallet transfer with transaction recording for both sender and receiver                                                                                                                                      |
| **116.4** | `controller/WalletController.java`              | N/A      | Get wallet transaction history                                                                                                                                                                                                   |
| **117**   | `controller/TransactionController.java`         | N/A      | Controller for transaction history api to fetch user's wallet transactions                                                                                                                                                       |
| **118**   | `application.properties`(api testing started)   | Line 6   | Update server port configuration from 5455 to 5454. Reflect final port setting for application deployment.                                                                                                                       |
| **119**   | `application.properties`                        | Line 15  | Add database cleanup instructions and payment API key setup. Include notes for database reset and configuration of Stripe/Razorpay credentials.                                                                                  |
